...
- [x] Στο αρχείο **[index]**(https://github.com/Mitato/fb-messenger-bot/blob/master/index.js), προσθέστε τον κώδικά σας που αφορά στις ερωτήσεις-απαντήσεις του chat bot της εργασίας σας.
